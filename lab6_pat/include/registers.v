...
`define IDS_BLOCK_ADDR_WIDTH            17
`define IDS_REG_ADDR_WIDTH              6
...
`define IDS_BLOCK_ADDR            17'h00003
...
`define IDS_COMMAND_REG        6'h0
`define IDS_MEM_ADDR_DEBUG     6'h1
`define IDS_MEM_DIN_DEBUG_LSB  6'h2
`define IDS_MEM_DIN_DEBUG_MSB  6'h3
`define IDS_LA_READ_ADDR       6'h4
`define IDS_IMEM_DOUT          6'h5
`define IDS_DMEM_DOUTB_LSB     6'h6
`define IDS_MEM_DOUT           6'h7
`define IDS_ID_R1_DATA_LSB     6'h8
`define IDS_ID_R2_DATA_LSB     6'h9
`define IDS_DPU_STATUS         6'ha
`define IDS_ALU_OUT            6'hb
`define IDS_WB_WRITEBACK_DATA  6'hc
`define IDS_CTRL_STATUS_0      6'hd
`define IDS_CTRL_STATUS_1      6'he
`define IDS_CTRL_STATUS_2      6'hf
`define IDS_CTRL_STATUS_3      6'h10
`define IDS_CTRL_STATUS_4      6'h11
`define IDS_CTRL_STATUS_5      6'h12
`define IDS_CTRL_STATUS_6      6'h13
`define IDS_CTRL_STATUS_7      6'h14
