...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                IDS_COMMAND_REG_REG
                IDS_MEM_ADDR_DEBUG_REG
                IDS_MEM_DIN_DEBUG_LSB_REG
                IDS_MEM_DIN_DEBUG_MSB_REG
                IDS_LA_READ_ADDR_REG
                IDS_IMEM_DOUT_REG
                IDS_DMEM_DOUTB_LSB_REG
                IDS_MEM_DOUT_REG
                IDS_ID_R1_DATA_LSB_REG
                IDS_ID_R2_DATA_LSB_REG
                IDS_DPU_STATUS_REG
                IDS_ALU_OUT_REG
                IDS_WB_WRITEBACK_DATA_REG
                IDS_CTRL_STATUS_0_REG
                IDS_CTRL_STATUS_1_REG
                IDS_CTRL_STATUS_2_REG
                IDS_CTRL_STATUS_3_REG
                IDS_CTRL_STATUS_4_REG
                IDS_CTRL_STATUS_5_REG
                IDS_CTRL_STATUS_6_REG
                IDS_CTRL_STATUS_7_REG
                OQ_QUEUE_0_CTRL_REG
...
sub IDS_COMMAND_REG_REG ()         { 0x2000300;}
sub IDS_MEM_ADDR_DEBUG_REG ()      { 0x2000304;}
sub IDS_MEM_DIN_DEBUG_LSB_REG ()   { 0x2000308;}
sub IDS_MEM_DIN_DEBUG_MSB_REG ()   { 0x200030c;}
sub IDS_LA_READ_ADDR_REG ()        { 0x2000310;}
sub IDS_IMEM_DOUT_REG ()           { 0x2000314;}
sub IDS_DMEM_DOUTB_LSB_REG ()      { 0x2000318;}
sub IDS_MEM_DOUT_REG ()            { 0x200031c;}
sub IDS_ID_R1_DATA_LSB_REG ()      { 0x2000320;}
sub IDS_ID_R2_DATA_LSB_REG ()      { 0x2000324;}
sub IDS_DPU_STATUS_REG ()          { 0x2000328;}
sub IDS_ALU_OUT_REG ()             { 0x200032c;}
sub IDS_WB_WRITEBACK_DATA_REG ()   { 0x2000330;}
sub IDS_CTRL_STATUS_0_REG ()       { 0x2000334;}
sub IDS_CTRL_STATUS_1_REG ()       { 0x2000338;}
sub IDS_CTRL_STATUS_2_REG ()       { 0x200033c;}
sub IDS_CTRL_STATUS_3_REG ()       { 0x2000340;}
sub IDS_CTRL_STATUS_4_REG ()       { 0x2000344;}
sub IDS_CTRL_STATUS_5_REG ()       { 0x2000348;}
sub IDS_CTRL_STATUS_6_REG ()       { 0x200034c;}
sub IDS_CTRL_STATUS_7_REG ()       { 0x2000350;}
