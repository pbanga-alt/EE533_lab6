...
package reg_defines_la_mem_test;
...
@EXPORT = qw(
                ...
                IDS_IMEM_DIN_REG
                IDS_DMEM_ADDRA_REG
                IDS_DMEM_DINA_LSB_REG
                IDS_DMEM_DINA_MSB_REG
                IDS_DMEM_ADDRB_REG
                IDS_DMEM_DINB_LSB_REG
                IDS_DMEM_DINB_MSB_REG
                IDS_LA_READ_ADDR_REG
                IDS_IMEM_DOUT_REG
                IDS_DMEM_DOUTA_LSB_REG
                IDS_DMEM_DOUTA_MSB_REG
                IDS_DMEM_DOUTB_LSB_REG
                IDS_DMEM_DOUTB_MSB_REG
                IDS_LA_STATUS_REG
                IDS_LA_DATA_0_REG
                IDS_LA_DATA_1_REG
                IDS_LA_DATA_2_REG
...
sub DEVICE_PROJ_DIR ()  { "la_mem_test"; }
...
sub IDS_IMEM_ADDR_REG ()        { 0x2000304;}
sub IDS_IMEM_DIN_REG ()         { 0x2000308;}
sub IDS_DMEM_ADDRA_REG ()       { 0x200030c;}
sub IDS_DMEM_DINA_LSB_REG ()    { 0x2000310;}
sub IDS_DMEM_DINA_MSB_REG ()    { 0x2000314;}
sub IDS_DMEM_ADDRB_REG ()       { 0x2000318;}
sub IDS_DMEM_DINB_LSB_REG ()    { 0x200031c;}
sub IDS_DMEM_DINB_MSB_REG ()    { 0x2000320;}
sub IDS_LA_READ_ADDR_REG ()     { 0x2000324;}
sub IDS_IMEM_DOUT_REG ()        { 0x2000328;}
sub IDS_DMEM_DOUTA_LSB_REG ()   { 0x200032c;}
sub IDS_DMEM_DOUTA_MSB_REG ()   { 0x2000330;}
sub IDS_DMEM_DOUTB_LSB_REG ()   { 0x2000334;}
sub IDS_DMEM_DOUTB_MSB_REG ()   { 0x2000338;}
sub IDS_LA_STATUS_REG ()        { 0x200033c;}
sub IDS_LA_DATA_0_REG ()        { 0x2000340;}
sub IDS_LA_DATA_1_REG ()        { 0x2000344;}
sub IDS_LA_DATA_2_REG ()        { 0x2000348;}
sub IDS_LA_DATA_3_REG ()        { 0x200034c;}
sub IDS_LA_DATA_4_REG ()        { 0x2000350;}
sub IDS_LA_DATA_5_REG ()        { 0x2000354;}
sub IDS_LA_DATA_6_REG ()        { 0x2000358;}
sub IDS_LA_DATA_7_REG ()        { 0x200035c;}
