...
# File: lib/verilog/core/output_port_lookup/cam_router/xml/cam_router.xml
def ROUTER_OP_LUT_ARP_NUM_MISSES_REG ():                
    return 0x2000000

def ROUTER_OP_LUT_LPM_NUM_MISSES_REG ():                
    return 0x2000004

def ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG ():             
    return 0x2000008

def ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG ():              
    return 0x200000c

def ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG ():               
    return 0x2000010

def ROUTER_OP_LUT_NUM_BAD_TTLS_REG ():                  
    return 0x2000014

def ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG ():               
    return 0x2000018

def ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG ():            
    return 0x200001c

def ROUTER_OP_LUT_NUM_WRONG_DEST_REG ():                
    return 0x2000020

def ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG ():             
    return 0x2000024

def ROUTER_OP_LUT_MAC_0_HI_REG ():                      
    return 0x2000028

def ROUTER_OP_LUT_MAC_0_LO_REG ():                      
    return 0x200002c

def ROUTER_OP_LUT_MAC_1_HI_REG ():                      
    return 0x2000030

def ROUTER_OP_LUT_MAC_1_LO_REG ():                      
    return 0x2000034

def ROUTER_OP_LUT_MAC_2_HI_REG ():                      
    return 0x2000038

def ROUTER_OP_LUT_MAC_2_LO_REG ():                      
    return 0x200003c

def ROUTER_OP_LUT_MAC_3_HI_REG ():                      
    return 0x2000040

def ROUTER_OP_LUT_MAC_3_LO_REG ():                      
    return 0x2000044

def ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ():          
    return 0x2000048

def ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ():        
    return 0x200004c

def ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG (): 
    return 0x2000050

def ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG (): 
    return 0x2000054

def ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ():           
    return 0x2000058

def ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ():           
    return 0x200005c

def ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ():        
    return 0x2000060

def ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ():        
    return 0x2000064

def ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ():   
    return 0x2000068

def ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ():             
    return 0x200006c

def ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ():             
    return 0x2000070

def ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ():  
    return 0x2000074

def ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ():   
    return 0x2000078

def ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ():   
    return 0x200007c
...
# Name: ids (IDS)
# Description: Registers for IDS with IMEM, DMEM and LA
# File: projects/la_mem_test/include/ids.xml
def IDS_COMMAND_REG_REG ():    
    return 0x2000300

def IDS_IMEM_ADDR_REG ():      
    return 0x2000304

def IDS_IMEM_DIN_REG ():       
    return 0x2000308

def IDS_DMEM_ADDRA_REG ():     
    return 0x200030c

def IDS_DMEM_DINA_LSB_REG ():  
    return 0x2000310

def IDS_DMEM_DINA_MSB_REG ():  
    return 0x2000314

def IDS_DMEM_ADDRB_REG ():     
    return 0x2000318

def IDS_DMEM_DINB_LSB_REG ():  
    return 0x200031c

def IDS_DMEM_DINB_MSB_REG ():  
    return 0x2000320

def IDS_LA_READ_ADDR_REG ():   
    return 0x2000324

def IDS_IMEM_DOUT_REG ():      
    return 0x2000328

def IDS_DMEM_DOUTA_LSB_REG (): 
    return 0x200032c

def IDS_DMEM_DOUTA_MSB_REG (): 
    return 0x2000330

def IDS_DMEM_DOUTB_LSB_REG (): 
    return 0x2000334

def IDS_DMEM_DOUTB_MSB_REG (): 
    return 0x2000338

def IDS_LA_STATUS_REG ():      
    return 0x200033c

def IDS_LA_DATA_0_REG ():      
    return 0x2000340

def IDS_LA_DATA_1_REG ():      
    return 0x2000344

def IDS_LA_DATA_2_REG ():      
    return 0x2000348

def IDS_LA_DATA_3_REG ():      
    return 0x200034c

def IDS_LA_DATA_4_REG ():      
    return 0x2000350

def IDS_LA_DATA_5_REG ():      
    return 0x2000354

def IDS_LA_DATA_6_REG ():      
    return 0x2000358

def IDS_LA_DATA_7_REG ():      
    return 0x200035c
...
__main__.nf_regmap.update({
    ...
    0x2000000 : "ROUTER_OP_LUT_ARP_NUM_MISSES_REG",
    0x2000004 : "ROUTER_OP_LUT_LPM_NUM_MISSES_REG",
    0x2000008 : "ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG",
    0x200000c : "ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG",
    0x2000010 : "ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG",
    0x2000014 : "ROUTER_OP_LUT_NUM_BAD_TTLS_REG",
    0x2000018 : "ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG",
    0x200001c : "ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG",
    0x2000020 : "ROUTER_OP_LUT_NUM_WRONG_DEST_REG",
    0x2000024 : "ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG",
    0x2000028 : "ROUTER_OP_LUT_MAC_0_HI_REG",
    0x200002c : "ROUTER_OP_LUT_MAC_0_LO_REG",
    0x2000030 : "ROUTER_OP_LUT_MAC_1_HI_REG",
    0x2000034 : "ROUTER_OP_LUT_MAC_1_LO_REG",
    0x2000038 : "ROUTER_OP_LUT_MAC_2_HI_REG",
    0x200003c : "ROUTER_OP_LUT_MAC_2_LO_REG",
    0x2000040 : "ROUTER_OP_LUT_MAC_3_HI_REG",
    0x2000044 : "ROUTER_OP_LUT_MAC_3_LO_REG",
    0x2000048 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG",
    0x200004c : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG",
    0x2000050 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x2000054 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG",
    0x2000058 : "ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG",
    0x200005c : "ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG",
    0x2000060 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG",
    0x2000064 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG",
    0x2000068 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x200006c : "ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG",
    0x2000070 : "ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG",
    0x2000074 : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG",
    ...
    0x2000300 : "IDS_COMMAND_REG_REG",
    0x2000304 : "IDS_IMEM_ADDR_REG",
    0x2000308 : "IDS_IMEM_DIN_REG",
    0x200030c : "IDS_DMEM_ADDRA_REG",
    0x2000310 : "IDS_DMEM_DINA_LSB_REG",
    0x2000314 : "IDS_DMEM_DINA_MSB_REG",
    0x2000318 : "IDS_DMEM_ADDRB_REG",
    0x200031c : "IDS_DMEM_DINB_LSB_REG",
    0x2000320 : "IDS_DMEM_DINB_MSB_REG",
    0x2000324 : "IDS_LA_READ_ADDR_REG",
    0x2000328 : "IDS_IMEM_DOUT_REG",
    0x200032c : "IDS_DMEM_DOUTA_LSB_REG",
    0x2000330 : "IDS_DMEM_DOUTA_MSB_REG",
    0x2000334 : "IDS_DMEM_DOUTB_LSB_REG",
    0x2000338 : "IDS_DMEM_DOUTB_MSB_REG",
    0x200033c : "IDS_LA_STATUS_REG",
    0x2000340 : "IDS_LA_DATA_0_REG",
    0x2000344 : "IDS_LA_DATA_1_REG",
    0x2000348 : "IDS_LA_DATA_2_REG",
    0x200034c : "IDS_LA_DATA_3_REG",
    0x2000350 : "IDS_LA_DATA_4_REG",
    0x2000354 : "IDS_LA_DATA_5_REG",
    0x2000358 : "IDS_LA_DATA_6_REG",
    0x200035c : "IDS_LA_DATA_7_REG",

    0x2001000 : "OQ_QUEUE_0_CTRL_REG",
    0x2001004 : "OQ_QUEUE_0_NUM_PKT_BYTES_STORED_REG",
    0x2001008 : "OQ_QUEUE_0_NUM_OVERHEAD_BYTES_STORED_REG",
    0x200100c : "OQ_QUEUE_0_NUM_PKT_BYTES_REMOVED_REG",
    0x2001010 : "OQ_QUEUE_0_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001014 : "OQ_QUEUE_0_NUM_PKTS_STORED_REG",
    0x2001018 : "OQ_QUEUE_0_NUM_PKTS_DROPPED_REG",
    0x200101c : "OQ_QUEUE_0_NUM_PKTS_REMOVED_REG",
    0x2001020 : "OQ_QUEUE_0_ADDR_LO_REG",
    0x2001024 : "OQ_QUEUE_0_ADDR_HI_REG",
    0x2001028 : "OQ_QUEUE_0_RD_ADDR_REG",
    0x200102c : "OQ_QUEUE_0_WR_ADDR_REG",
    0x2001030 : "OQ_QUEUE_0_NUM_PKTS_IN_Q_REG",
    0x2001034 : "OQ_QUEUE_0_MAX_PKTS_IN_Q_REG",
    0x2001038 : "OQ_QUEUE_0_NUM_WORDS_IN_Q_REG",
    0x200103c : "OQ_QUEUE_0_NUM_WORDS_LEFT_REG",
    0x2001040 : "OQ_QUEUE_0_FULL_THRESH_REG",
    0x2001200 : "OQ_QUEUE_1_CTRL_REG",
    0x2001204 : "OQ_QUEUE_1_NUM_PKT_BYTES_STORED_REG",
    0x2001208 : "OQ_QUEUE_1_NUM_OVERHEAD_BYTES_STORED_REG",
    0x200120c : "OQ_QUEUE_1_NUM_PKT_BYTES_REMOVED_REG",
    0x2001210 : "OQ_QUEUE_1_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001214 : "OQ_QUEUE_1_NUM_PKTS_STORED_REG",
    0x2001218 : "OQ_QUEUE_1_NUM_PKTS_DROPPED_REG",
    0x200121c : "OQ_QUEUE_1_NUM_PKTS_REMOVED_REG",
    0x2001220 : "OQ_QUEUE_1_ADDR_LO_REG",
    0x2001224 : "OQ_QUEUE_1_ADDR_HI_REG",
    0x2001228 : "OQ_QUEUE_1_RD_ADDR_REG",
    0x200122c : "OQ_QUEUE_1_WR_ADDR_REG",
    0x2001230 : "OQ_QUEUE_1_NUM_PKTS_IN_Q_REG",
    0x2001234 : "OQ_QUEUE_1_MAX_PKTS_IN_Q_REG",
    0x2001238 : "OQ_QUEUE_1_NUM_WORDS_IN_Q_REG",
    0x200123c : "OQ_QUEUE_1_NUM_WORDS_LEFT_REG",
    0x2001240 : "OQ_QUEUE_1_FULL_THRESH_REG",
    0x2001400 : "OQ_QUEUE_2_CTRL_REG",
    0x2001404 : "OQ_QUEUE_2_NUM_PKT_BYTES_STORED_REG",
    0x2001408 : "OQ_QUEUE_2_NUM_OVERHEAD_BYTES_STORED_REG",
    0x200140c : "OQ_QUEUE_2_NUM_PKT_BYTES_REMOVED_REG",
    0x2001410 : "OQ_QUEUE_2_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001414 : "OQ_QUEUE_2_NUM_PKTS_STORED_REG",
    0x2001418 : "OQ_QUEUE_2_NUM_PKTS_DROPPED_REG",
    0x200141c : "OQ_QUEUE_2_NUM_PKTS_REMOVED_REG",
    0x2001420 : "OQ_QUEUE_2_ADDR_LO_REG",
    0x2001424 : "OQ_QUEUE_2_ADDR_HI_REG",
    0x2001428 : "OQ_QUEUE_2_RD_ADDR_REG",
    0x200142c : "OQ_QUEUE_2_WR_ADDR_REG",
    0x2001430 : "OQ_QUEUE_2_NUM_PKTS_IN_Q_REG",
    0x2001434 : "OQ_QUEUE_2_MAX_PKTS_IN_Q_REG",
    0x2001438 : "OQ_QUEUE_2_NUM_WORDS_IN_Q_REG",
    0x200143c : "OQ_QUEUE_2_NUM_WORDS_LEFT_REG",
    0x2001440 : "OQ_QUEUE_2_FULL_THRESH_REG",
    0x2001600 : "OQ_QUEUE_3_CTRL_REG",
    0x2001604 : "OQ_QUEUE_3_NUM_PKT_BYTES_STORED_REG",
    0x2001608 : "OQ_QUEUE_3_NUM_OVERHEAD_BYTES_STORED_REG",
    0x200160c : "OQ_QUEUE_3_NUM_PKT_BYTES_REMOVED_REG",
    0x2001610 : "OQ_QUEUE_3_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001614 : "OQ_QUEUE_3_NUM_PKTS_STORED_REG",
    0x2001618 : "OQ_QUEUE_3_NUM_PKTS_DROPPED_REG",
    0x200161c : "OQ_QUEUE_3_NUM_PKTS_REMOVED_REG",
    0x2001620 : "OQ_QUEUE_3_ADDR_LO_REG",
    0x2001624 : "OQ_QUEUE_3_ADDR_HI_REG",
    0x2001628 : "OQ_QUEUE_3_RD_ADDR_REG",
    0x200162c : "OQ_QUEUE_3_WR_ADDR_REG",
    0x2001630 : "OQ_QUEUE_3_NUM_PKTS_IN_Q_REG",
    0x2001634 : "OQ_QUEUE_3_MAX_PKTS_IN_Q_REG",
    0x2001638 : "OQ_QUEUE_3_NUM_WORDS_IN_Q_REG",
    0x200163c : "OQ_QUEUE_3_NUM_WORDS_LEFT_REG",
    0x2001640 : "OQ_QUEUE_3_FULL_THRESH_REG",
    0x2001800 : "OQ_QUEUE_4_CTRL_REG",
    0x2001804 : "OQ_QUEUE_4_NUM_PKT_BYTES_STORED_REG",
    0x2001808 : "OQ_QUEUE_4_NUM_OVERHEAD_BYTES_STORED_REG",
    0x200180c : "OQ_QUEUE_4_NUM_PKT_BYTES_REMOVED_REG",
    0x2001810 : "OQ_QUEUE_4_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001814 : "OQ_QUEUE_4_NUM_PKTS_STORED_REG",
    0x2001818 : "OQ_QUEUE_4_NUM_PKTS_DROPPED_REG",
    0x200181c : "OQ_QUEUE_4_NUM_PKTS_REMOVED_REG",
    0x2001820 : "OQ_QUEUE_4_ADDR_LO_REG",
    0x2001824 : "OQ_QUEUE_4_ADDR_HI_REG",
    0x2001828 : "OQ_QUEUE_4_RD_ADDR_REG",
    0x200182c : "OQ_QUEUE_4_WR_ADDR_REG",
    0x2001830 : "OQ_QUEUE_4_NUM_PKTS_IN_Q_REG",
    0x2001834 : "OQ_QUEUE_4_MAX_PKTS_IN_Q_REG",
    0x2001838 : "OQ_QUEUE_4_NUM_WORDS_IN_Q_REG",
    0x200183c : "OQ_QUEUE_4_NUM_WORDS_LEFT_REG",
    0x2001840 : "OQ_QUEUE_4_FULL_THRESH_REG",
    0x2001a00 : "OQ_QUEUE_5_CTRL_REG",
    0x2001a04 : "OQ_QUEUE_5_NUM_PKT_BYTES_STORED_REG",
    0x2001a08 : "OQ_QUEUE_5_NUM_OVERHEAD_BYTES_STORED_REG",
    0x2001a0c : "OQ_QUEUE_5_NUM_PKT_BYTES_REMOVED_REG",
    0x2001a10 : "OQ_QUEUE_5_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001a14 : "OQ_QUEUE_5_NUM_PKTS_STORED_REG",
    0x2001a18 : "OQ_QUEUE_5_NUM_PKTS_DROPPED_REG",
    0x2001a1c : "OQ_QUEUE_5_NUM_PKTS_REMOVED_REG",
    0x2001a20 : "OQ_QUEUE_5_ADDR_LO_REG",
    0x2001a24 : "OQ_QUEUE_5_ADDR_HI_REG",
    0x2001a28 : "OQ_QUEUE_5_RD_ADDR_REG",
    0x2001a2c : "OQ_QUEUE_5_WR_ADDR_REG",
    0x2001a30 : "OQ_QUEUE_5_NUM_PKTS_IN_Q_REG",
    0x2001a34 : "OQ_QUEUE_5_MAX_PKTS_IN_Q_REG",
    0x2001a38 : "OQ_QUEUE_5_NUM_WORDS_IN_Q_REG",
    0x2001a3c : "OQ_QUEUE_5_NUM_WORDS_LEFT_REG",
    0x2001a40 : "OQ_QUEUE_5_FULL_THRESH_REG",
    0x2001c00 : "OQ_QUEUE_6_CTRL_REG",
    0x2001c04 : "OQ_QUEUE_6_NUM_PKT_BYTES_STORED_REG",
    0x2001c08 : "OQ_QUEUE_6_NUM_OVERHEAD_BYTES_STORED_REG",
    0x2001c0c : "OQ_QUEUE_6_NUM_PKT_BYTES_REMOVED_REG",
    0x2001c10 : "OQ_QUEUE_6_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001c14 : "OQ_QUEUE_6_NUM_PKTS_STORED_REG",
    0x2001c18 : "OQ_QUEUE_6_NUM_PKTS_DROPPED_REG",
    0x2001c1c : "OQ_QUEUE_6_NUM_PKTS_REMOVED_REG",
    0x2001c20 : "OQ_QUEUE_6_ADDR_LO_REG",
    0x2001c24 : "OQ_QUEUE_6_ADDR_HI_REG",
    0x2001c28 : "OQ_QUEUE_6_RD_ADDR_REG",
    0x2001c2c : "OQ_QUEUE_6_WR_ADDR_REG",
    0x2001c30 : "OQ_QUEUE_6_NUM_PKTS_IN_Q_REG",
    0x2001c34 : "OQ_QUEUE_6_MAX_PKTS_IN_Q_REG",
    0x2001c38 : "OQ_QUEUE_6_NUM_WORDS_IN_Q_REG",
    0x2001c3c : "OQ_QUEUE_6_NUM_WORDS_LEFT_REG",
    0x2001c40 : "OQ_QUEUE_6_FULL_THRESH_REG",
    0x2001e00 : "OQ_QUEUE_7_CTRL_REG",
    0x2001e04 : "OQ_QUEUE_7_NUM_PKT_BYTES_STORED_REG",
    0x2001e08 : "OQ_QUEUE_7_NUM_OVERHEAD_BYTES_STORED_REG",
    0x2001e0c : "OQ_QUEUE_7_NUM_PKT_BYTES_REMOVED_REG",
    0x2001e10 : "OQ_QUEUE_7_NUM_OVERHEAD_BYTES_REMOVED_REG",
    0x2001e14 : "OQ_QUEUE_7_NUM_PKTS_STORED_REG",
    0x2001e18 : "OQ_QUEUE_7_NUM_PKTS_DROPPED_REG",
    0x2001e1c : "OQ_QUEUE_7_NUM_PKTS_REMOVED_REG",
    0x2001e20 : "OQ_QUEUE_7_ADDR_LO_REG",
    0x2001e24 : "OQ_QUEUE_7_ADDR_HI_REG",
    0x2001e28 : "OQ_QUEUE_7_RD_ADDR_REG",
    0x2001e2c : "OQ_QUEUE_7_WR_ADDR_REG",
    0x2001e30 : "OQ_QUEUE_7_NUM_PKTS_IN_Q_REG",
    0x2001e34 : "OQ_QUEUE_7_MAX_PKTS_IN_Q_REG",
    0x2001e38 : "OQ_QUEUE_7_NUM_WORDS_IN_Q_REG",
    0x2001e3c : "OQ_QUEUE_7_NUM_WORDS_LEFT_REG",
    0x2001e40 : "OQ_QUEUE_7_FULL_THRESH_REG",
