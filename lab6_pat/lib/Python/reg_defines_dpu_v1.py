...
# Name: ids (IDS)
# Description: Registers for Skeleton Pipelined DPU
# File: projects/dpu_v1/include/ids.xml
def IDS_COMMAND_REG_REG ():       
    return 0x2000300

def IDS_MEM_ADDR_DEBUG_REG ():    
    return 0x2000304

def IDS_MEM_DIN_DEBUG_LSB_REG (): 
    return 0x2000308

def IDS_MEM_DIN_DEBUG_MSB_REG (): 
    return 0x200030c
...
def IDS_MEM_DOUT_REG ():          
    return 0x200031c

def IDS_ID_R1_DATA_LSB_REG ():    
    return 0x2000320

def IDS_ID_R2_DATA_LSB_REG ():    
    return 0x2000324

def IDS_DPU_STATUS_REG ():        
    return 0x2000328

def IDS_ALU_OUT_REG ():           
    return 0x200032c

def IDS_WB_WRITEBACK_DATA_REG (): 
    return 0x2000330

def IDS_CTRL_STATUS_0_REG ():     
    return 0x2000334

def IDS_CTRL_STATUS_1_REG ():     
    return 0x2000338

def IDS_CTRL_STATUS_2_REG ():     
    return 0x200033c

def IDS_CTRL_STATUS_3_REG ():     
    return 0x2000340

def IDS_CTRL_STATUS_4_REG ():     
    return 0x2000344

def IDS_CTRL_STATUS_5_REG ():     
    return 0x2000348

def IDS_CTRL_STATUS_6_REG ():     
    return 0x200034c

def IDS_CTRL_STATUS_7_REG ():     
    return 0x2000350
...
__main__.nf_regmap.update({
    ...
    0x2000304 : "IDS_MEM_ADDR_DEBUG_REG",
    0x2000308 : "IDS_MEM_DIN_DEBUG_LSB_REG",
    0x200030c : "IDS_MEM_DIN_DEBUG_MSB_REG",
    0x2000310 : "IDS_LA_READ_ADDR_REG",
    0x2000314 : "IDS_IMEM_DOUT_REG",
    0x2000318 : "IDS_DMEM_DOUTB_LSB_REG",
    0x200031c : "IDS_MEM_DOUT_REG",
    0x2000320 : "IDS_ID_R1_DATA_LSB_REG",
    0x2000324 : "IDS_ID_R2_DATA_LSB_REG",
    0x2000328 : "IDS_DPU_STATUS_REG",
    0x200032c : "IDS_ALU_OUT_REG",
    0x2000330 : "IDS_WB_WRITEBACK_DATA_REG",
    0x2000334 : "IDS_CTRL_STATUS_0_REG",
    0x2000338 : "IDS_CTRL_STATUS_1_REG",
    0x200033c : "IDS_CTRL_STATUS_2_REG",
    0x2000340 : "IDS_CTRL_STATUS_3_REG",
    0x2000344 : "IDS_CTRL_STATUS_4_REG",
    0x2000348 : "IDS_CTRL_STATUS_5_REG",
    0x200034c : "IDS_CTRL_STATUS_6_REG",
    0x2000350 : "IDS_CTRL_STATUS_7_REG",
